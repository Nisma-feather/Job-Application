...
const UserInterestForm = ({ navigation, route }) => {
  ...
  console.log({loginData,personalData})
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      console.log("Accunt created successfully")
  ...
  return (
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          style={[
            styles.nextButton,
            (!formData[Object.keys(formData)[currentStep-1]] || loading) && styles.disabledButton
          ]} 
          onPress={nextStep }
          disabled={!formData[Object.keys(formData)[currentStep-1]] || loading}
        >
