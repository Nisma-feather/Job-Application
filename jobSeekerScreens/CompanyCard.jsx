      ...
      <ScrollView>
        ...
        {/* <View style={styles.tabs}>
         ...
         <View style={styles.tabs}>
                  ...
                  <TouchableOpacity onPress={() => setActiveTab('open jobs')} style={[styles.tab, activeTab === 'open jobs' && styles.activeTab]}>
                    <Text style={activeTab === 'open jobs' ? styles.activeTabText : styles.tabText}>Open Jobs</Text>
                  </TouchableOpacity>
          ...
          <View style={styles.aboutContainer}>
            ...
            <View style={styles.infoRow}>
              <View style={{display:'flex',flexDirection:'row',alignItems:'center',gap:10}}>
                <MaterialCommunityIcons name="web" color="#1967d2" size={24} />
                <Text style={styles.value}>Website</Text>
              </View>
              <Text style={styles.label}>{company.website || 'www.example.com'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <View style={{display:'flex',flexDirection:'row',alignItems:'center',gap:10}}>
                <Ionicons name="location-outline" color="#1967d2" size={24}/>
                <Text style={styles.value}>Headquarters</Text>
              </View>
              <Text style={styles.label}>{company.locations || 'Not specified'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <View style={{display:'flex',flexDirection:'row',alignItems:'center',gap:10}}>
                <FontAwesome name="calendar" color="#1967d2" size={24} />
            ...
            <View style={styles.infoRow}>
              <View style={{display:'flex',flexDirection:'row',alignItems:'center',gap:10}}>
                <Foundation name="torsos" color="#1967d2" size={24} />
                <Text style={styles.value}>Size</Text>
              </View>
              <Text style={styles.label}>{company.employeeCount || 'Not specified'}</Text>
            </View>
          </View>
        )}
